...
const AddFood = ({ setProductData, categories = DefaultCategories }) => {
  ...
  return (
    <div className="p-3 sm:p-4 md:p-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-5 md:gap-6 items-start">
        {/* Form card */}
        <div className="bg-white rounded-2xl shadow p-4 sm:p-6 md:p-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-6">
            ...
            <button
              ...
              className="self-start sm:self-auto text-sm text-gray-500 hover:text-red-600 transition-colors cursor-pointer whitespace-nowrap"
            >
          ...
          >
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="w-full max-w-[220px] aspect-square rounded-xl bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden mx-auto">
                {preview ? (
                  <img
                    src={preview}
                    alt="Food preview"
              ...
              <label className="w-full max-w-[220px] text-center text-sm bg-gray-100 hover:bg-gray-200 transition-colors rounded-md py-2 cursor-pointer">
                Upload photo
                <input
                  type="file"
                  accept="image/*"
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-2">
                <button
                  type="submit"
                  className="flex items-center justify-center gap-2 px-6 py-2.5 rounded-full bg-red-500 hover:bg-red-600 text-white text-sm font-semibold transition-colors cursor-pointer"
                >
        ...
        <div className="lg:sticky lg:top-6">
          ...
          <div className="w-full max-w-[280px] sm:max-w-[260px] mx-auto lg:mx-0 shadow rounded-[10px] bg-white overflow-hidden">
